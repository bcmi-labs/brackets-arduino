...
function Platform() {
    ...
    this.getReposPath = function() {
        ...
        return this.getUserHome() + '/AppData/Roaming/Brackets/extensions/user/Compiler/node';
    }
	...
	this.getCorePathNEW = function(opt) {
		var ark = opt.device.build.board.substring(0,opt.device.build.board.indexOf("_")).toLowerCase();
        return this.root + '/hardware/arduino/'+ark+'/cores/'+opt.device.build.core;
    }
	...
	this.getVariantPathNEW = function(opt) {
		var ark = opt.device.build.board.substring(0,opt.device.build.board.indexOf("_")).toLowerCase();
        return this.root + '/hardware/arduino/'+ark+'/variants/'+opt.device.build.variant;
    }
